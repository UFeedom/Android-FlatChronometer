...
public class Titanic {
    ...
    public Titanic(Context context ){
    ...
    public void start(final TitanicTextView textView) {
        ...
        final Runnable animate = new Runnable() {
            ...
            public void run() {
                ...
                //280
                Drawable wave = mContext.getResources().getDrawable(R.drawable.wave_blue);
                
                ObjectAnimator maskXAnimator = ObjectAnimator.ofFloat(textView, "maskX", 0, wave.getIntrinsicWidth());
